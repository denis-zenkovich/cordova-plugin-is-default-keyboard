...
public class DefaultKeyboard extends CordovaPlugin {

    private final String ERROR_UNKNOWN_ACTION = "Unknown action";

    public static final String LOG_TAG = "DefaultKeyboard";
                ...
                cordova.getThreadPool().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            LOG.i(LOG_TAG, "Default Keyboard:" + isUsingDefaultKeyboard());
    ...
    private boolean isUsingDefaultKeyboard() {
        ...
        for (InputMethodInfo inputMethodInfo : inputMethodList)
            if (inputMethodInfo.getId().equals(Settings.Secure.getString(context.getContentResolver(),
